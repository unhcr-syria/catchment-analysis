...
### Now we can run the 3 series of maps

## Map that displays label
source('code/3-Map-label.R', echo=TRUE)

## Map that displays categorise numeric value
source('code/3-Map-color.R', echo=TRUE)

## Map that displays categorise  value
source('code/3-Map-color.R', echo=TRUE)